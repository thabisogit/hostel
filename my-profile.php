...
//echo "<pre>".print_r(array($regno,$fname,$mname,$lname,$gender,$contactno,$udate,$aid),true)."</pre>";//exit;
...
<body>
	...
	<?php	
$aid=$_SESSION['id'];
	//$ret="select * from registration where id=".$aid;
	$ret = mysqli_query($conn, "select * from registration where id=".$aid);
