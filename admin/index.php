...
//$stmt=$mysqli->prepare("SELECT username,email,password,id FROM admin WHERE (userName=?|| email=?) and password=? ");
	$stmt=$mysqli->prepare("SELECT emailid,password,id FROM registration WHERE emailid=? and password=? and deleted is null or deleted <> 1");
   ...
   // $stmtins->bind_param('sH',$id,$uip);
    //$res=$stmtins->execute();
		if($username == 'thabisongubane1992@gmail.com'){
				...
				<div class="container">
					<div class="row">
						<div class="col-md-6 col-md-offset-3">
							<h1 class="text-center text-bold text-light mt-4x">Property Management System</h1>
